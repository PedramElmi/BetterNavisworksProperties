...
namespace BetterPropertiesDockpane.MVVM.Views.Converters
{
    class ModelItemToModelItemIconImage : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var uriString = @"/BetterPropertiesDockpane.PedramElmi;component/Images/";
            var targetIconType = (value as ModelItem).GetIconType();

            switch (targetIconType)
            {
                case NavisworksDevHelper.ModelItemHelpers.IconType.Unidentified:
                    goto default;
                case NavisworksDevHelper.ModelItemHelpers.IconType.File:
                    uriString += "GUID-2D8532F2-122E-4218-9E22-44C4BC834F7C.png";
                    break;
                case NavisworksDevHelper.ModelItemHelpers.IconType.Layer:
                    uriString += "GUID-4BCD09CF-FF0C-4B88-B473-B1025A17C100.png";
                    break;
                case NavisworksDevHelper.ModelItemHelpers.IconType.Collection:
                    uriString += "GUID-7AD510FA-7C48-415E-9579-D996820D8BC1.png";
                    break;
                case NavisworksDevHelper.ModelItemHelpers.IconType.CompositeObject:
                    uriString += "GUID-197CB0CC-4CBB-4308-A42C-0B7046B05392.png";
                    break;
                case NavisworksDevHelper.ModelItemHelpers.IconType.InsertGroup:
                    uriString += "GUID-A12DD8E6-A4BE-401A-BB86-6C80E4C4C1FB.png";
                    break;
                case NavisworksDevHelper.ModelItemHelpers.IconType.Geometry:
